...
public class SyntricCLI {
    ...
    public SyntricCLI(QueryExecutor inProcessExecutor) {
        this.inProcessExecutor = inProcessExecutor;
    }

    public static void main(String[] args) {
        SyntricCLI cli = new SyntricCLI();
    ...
    public void parseArgsAndStart(String[] args) {
        ...
        System.out.println("==================================================================");
        System.out.println("⚡ Welcome to SyntricDB AI-Native Interactive CLI Shell ⚡");
        System.out.println("==================================================================");
        ...
        if (inProcessExecutor == null) {
            ...
            System.out.println("Connecting to SyntricDB at " + serverUrl + " as user '" + username + "'...");
        } else {
            System.out.println("Connected to in-process SyntricDB Engine instance.");
        }
