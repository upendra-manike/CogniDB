...
public class RAGEngine {
    ...
    public RAGResult query(String tableName, String vectorColumn, String prompt, int topK) throws Exception {
        ...
        String augmentedPrompt = "Context retrieved from CogniDB:\n" + contextText + "\nUser Question: " + prompt;
        String generatedAnswer = "Based on CogniDB vector context: Found " + retrieved.size() + " highly relevant profile matches. Key specialist: " + (retrieved.isEmpty() ? "None" : retrieved.get(0).get("name"));
