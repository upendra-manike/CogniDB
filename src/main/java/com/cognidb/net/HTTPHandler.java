    ...
    private void handleApi(ChannelHandlerContext ctx, FullHttpRequest req) throws Exception {
        ...
        try {
            if ("/api/sql".equals(uri) && req.method() == HttpMethod.POST) {
                ...
                com.cognidb.ai.RAGEngine rag = new com.cognidb.ai.RAGEngine(storageEngine, aiEngine);
                com.cognidb.ai.RAGEngine.RAGResult ragRes = rag.query(table, column, prompt, limit);
