...
import com.cognidb.ai.RAGEngine;
import com.cognidb.engine.StorageEngine;
import com.cognidb.engine.columnar.ColumnSegment;
import com.cognidb.engine.columnar.VectorizedBatch;
import com.cognidb.engine.schema.ColumnType;
import com.cognidb.engine.schema.Tuple;
import com.cognidb.engine.txn.Transaction;
import com.cognidb.engine.txn.TransactionManager;
...
public class ProductFeatureTest {
    ...
    public void testRAGEngineQuery() throws Exception {
        storageEngine.createTable(new com.cognidb.engine.schema.TableSchema("users")
                .addColumn(new com.cognidb.engine.schema.ColumnDef("id", ColumnType.VARCHAR, true, true))
                .addColumn(new com.cognidb.engine.schema.ColumnDef("name", ColumnType.VARCHAR, false, false))
                .addColumn(new com.cognidb.engine.schema.ColumnDef("bio", ColumnType.VARCHAR, false, false))
                .addColumn(new com.cognidb.engine.schema.ColumnDef("embedding", ColumnType.FLOAT_VECTOR, 128, false, true)));
