...
public class SyntricDbDemoApplication {

    public static void main(String[] args) {
        SpringApplication.run(SyntricDbDemoApplication.class, args);
    }
    ...
    public CommandLineRunner runDemo(ProductService productService) {
        return args -> {
            System.out.println("=================================================");
            System.out.println("🚀 SyntricDB Spring Boot & JPA Integration Demo");
            System.out.println("=================================================");
            ...
            System.out.println("\n🔍 SyntricDB Native Vector Search Result:");
